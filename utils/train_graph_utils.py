...
from utils.gen_filter_coe import gen_filter_coe
...
class train_utils(object):
    ...
    def setup(self):
        ...
        self.datasets['train'], self.datasets['val'], data_sample = Dataset(args.sample_length, args.data_dir, args.Input_type, args.task).data_preprare()
    ...
    #-------------Define the model-------------------------------
        ...
        self.r = self.s + 1
        self.d_list = gen_filter_coe(dataset=data_sample, num_nodes=self.num_nodes, s=self.s, n=self.n, r=self.r, device=self.device)

        if args.task == 'Graph':
            self.model = getattr(models, args.model_name)(feature=feature, nhid=args.nhid, out_channel=Dataset.num_classes,
                                                           r=self.r, num_nodes=self.num_nodes,
            ...
            for phase in ['train', 'val']:
                ...
                for data in self.dataloaders[phase]:
                    ...
                    with torch.set_grad_enabled(phase == 'train'):
                        ...
                        logits = self.model(inputs, self.d_list)
